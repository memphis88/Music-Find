...
/*
 * Μέθοδος που παίρνει ως όρισμα αλφαριθμητικό και δεδομένα και επιστρέφει την τιμή του αντίστοιχου πεδίου απο τα δεδομένα JSON.
 */
...
/*
 * Μέθοδος που παίρνει ως όρισμα αλφαριθμητικό και δεδομένα και επιστρέφει πίνακα με δεδομένα του αντίστοιχου πεδίου απο τα δεδομένα JSON.
 */
...
/*
 * Μέθοδος που ελέγχει αν τα δεδομένα έχουν πληροφορίες για σελιδοποίηση.
 */
...
/*
 * Μέθοδος που παίρνει ως όρισμα δεδομένα και επιστρέφει πίνακα με δεδομένα JSON χωρίς τη σελιδοποίηση, ενοποιημένα. Καλείται όταν οι σελίδες αποτελεσμάτων είναι λιγότερες απο 5.
 */
...
/*
 * Μέθοδος που παίρνει ως όρισμα δεδομένα και επιστρέφει πίνακα με τις πρώτες 5 σελίδες δεδομένων JSON.
 */
...
/*
 * Μέθοδος που παίρνει ως όρισμα το URL της επόμενης σελίδας αποτελεσμάτων και επιστρέφει πίνακα δεδομένων JSON τριών σελίδων (εάν υπάρχουν 3).
 */
